...
from apps.Solution_Catalog.views import get_main_tree, get_user_tree, \
    ...
    view_folder_as_test, change_folder_access_status, main_page_moderation, show_tasks_moderation, accept_changes

urlpatterns = [
    re_path(r'main_page_moderation', main_page_moderation, name="main_page_moderation"),
    re_path(r'main_page', main_page),
    re_path(r'attr_tree$', attr_tree),
    re_path(r'accept_changes', accept_changes, name="accept_changes"),

    re_path(r'get_main_tree', get_main_tree),
    re_path(r'get_user_tree', get_user_tree),

    re_path(r'show_tasks_moderation', show_tasks_moderation, name="show_tasks_moderation"),
